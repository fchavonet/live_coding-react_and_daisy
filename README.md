    ...
    <tr valign="top">
        <td align="center">
            <picture>
                ...
                <img width="100%" src="./public/images/screenshots/screenshot-desktop-react_and_daisy-light.webp" alt="Desktop Screenshot">
            </picture>
        </td>
        <td align="center">
            <picture>
                ...
                <img width="100%" src="./public/images/screenshots/screenshot-mobile-react_and_daisy-light.webp" alt="Mobile Screenshot">
            </picture>
        </td>
    </tr>
</table>
